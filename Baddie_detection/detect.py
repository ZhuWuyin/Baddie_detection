import cv2, pyautogui, time, keyboard, datetime, os
...
start_hotkey = input("start hotkey: ")
end_hotkey = input("end hotkey: ")
...
excluded_keys=[start_hotkey, end_hotkey]
...
while True:
    ...
    if keyboard.is_pressed(start_hotkey) and not start:
        start=True
    if keyboard.is_pressed(end_hotkey) and start:
        start=False
